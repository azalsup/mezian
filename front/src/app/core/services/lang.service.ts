...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    postAdPhotos:         'Photos',
    postAdPhotosOptional: 'optionnel',
    postAdPhotosHint:     'La première photo sera utilisée comme couverture. Max 5 photos.',
  ...
  en: {
    ...
    postAdPhotos:         'Photos',
    postAdPhotosOptional: 'optional',
    postAdPhotosHint:     'The first photo will be used as the cover. Max 5 photos.',
  ...
  ar: {
    ...
    postAdPhotos:         'الصور',
    postAdPhotosOptional: 'اختياري',
    postAdPhotosHint:     'ستُستخدم الصورة الأولى كغلاف. بحد أقصى 5 صور.',
